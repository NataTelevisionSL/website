...
export type HomeSection = "works" | "studio" | "contact";

export default function HomePage({ initialSection }: { initialSection?: HomeSection }) {
  const { t } = useLang();
  ...
  useEffect(() => {
    ...
    // Wait a frame so layout (and sticky nav) is ready
      ...
      <section id="studio" className="text-white">
        ...
        <footer className="border-t border-b border-neutral-800 grid grid-cols-1 sm:grid-cols-3 gap-0 text-sm">
          ...
          <div className="px-8 py-10">
            ...
            <ul className="space-y-1">
              <li>
                <SectionLink href="/works" section="works" className="text-rose-400 hover:underline underline-offset-4">
                  {t.nav.works}
                </SectionLink>
              </li>
              <li>
                <SectionLink href="/studio" section="studio" className="text-rose-400 hover:underline underline-offset-4">
                  {t.nav.studio}
                </SectionLink>
              </li>
              <li>
                <SectionLink href="/contact" section="contact" className="text-rose-400 hover:underline underline-offset-4">
                  {t.studio.contact}
                </SectionLink>
              </li>
              <li>
                <SectionLink href="/academia" className="text-rose-400 hover:underline underline-offset-4">
                  {t.academia.title}
                </SectionLink>
              </li>
            </ul>
